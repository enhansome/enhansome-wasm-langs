...
* [Blazor](https://dotnet.microsoft.com/apps/aspnet/web-apps/blazor) - a web UI framework using C#/Razor and HTML, running client-side via WebAssembly. Source is maintained on [ASP.Net Core](https://github.com/dotnet/aspnetcore) ⭐ 38,457 | 🐛 4,183 | 🌐 C# | 📅 2026-09-21 repo.
* [Mono](https://github.com/mono/mono/tree/master/sdks/wasm) ⭐ 11,466 | 🐛 2,267 | 🌐 C# | 📅 2024-08-27 - an open source implementation of Microsoft's .NET Framework based on the ECMA standards for C# and the Common Language Runtime. For a real-work example, see this repository which contains the [Windows 10 calculator](https://github.com/nventive/calculator) ⭐ 416 | 🐛 61 | 🌐 C# | 📅 2025-08-26. The application is built using standard C++ 11 and C++/CX, with a calculation engine that dates back from 1995. Made by possible with mono via [Uno Platform](https://platform.uno/a-piece-of-windows-10-is-now-running-on-webassembly-natively-on-ios-and-android/).
* [NativeAOT-LLVM](https://github.com/dotnet/runtimelab/tree/feature/NativeAOT-LLVM) ⭐ 1,617 | 🐛 249 | 📅 2026-09-21 - an experimental fork of the CoreCLR .NET runtime that compiles .NET applications into single-file executables, with the primary target being WASM
...
* [Emscripten](https://github.com/kripken/emscripten) ⭐ 27,620 | 🐛 2,487 | 🌐 C++ | 📅 2026-09-21 - an LLVM-to-JavaScript/Webassembly compiler. It takes LLVM bitcode - which can be generated from C/C++, using llvm-gcc (DragonEgg) or clang, or any other language that can be converted into LLVM - and compiles that into JavaScript or wasm.
...
* [Crystal](https://github.com/crystal-lang/crystal) ⭐ 20,417 | 🐛 2,044 | 🌐 Crystal | 📅 2026-09-19 - main repository
* [POC PR](https://github.com/crystal-lang/crystal/pull/10870) ⭐ 20,417 | 🐛 2,044 | 🌐 Crystal | 📅 2026-09-19 - PR adding initial support for WebAssembly
...
* [LDC](https://github.com/ldc-developers/ldc) ⭐ 1,371 | 🐛 584 | 🌐 D | 📅 2026-09-20 - LLVM-based D compiler, which can generate WASM since version 1.11.0.
...
* [sdk](https://github.com/dart-lang/sdk) ⭐ 11,290 | 🐛 8,405 | 🌐 Dart | 📅 2026-09-21 - The Dart SDK, including the VM, dart2js, core libraries, and more.
* [language](https://github.com/dart-lang/language) ⭐ 2,933 | 🐛 1,284 | 🌐 TeX | 📅 2026-09-18 - Design of the Dart language
...
* [eel-wasm](https://github.com/captbaritone/eel-wasm) ⭐ 60 | 🐛 10 | 🌐 TypeScript | 📅 2025-12-16 - Compiles Milkdrop flavored Eel to Wasm in the browser. Intended to become a component of [Butterchurn](https://github.com/jberg/butterchurn) ⭐ 1,950 | 🐛 24 | 🌐 JavaScript | 📅 2026-04-20, a WebGL implementation of the Milkdrop Visualizer.
...
* [Faust](https://github.com/grame-cncm/faust) ⭐ 3,161 | 🐛 256 | 🌐 C++ | 📅 2026-09-21 - main repository.
...
* [Go](https://github.com/golang/go) ⭐ 138,921 | 🐛 10,164 | 🌐 Go | 📅 2026-09-20 - main repository.
* [TinyGo](https://github.com/aykevl/tinygo) ⭐ 17,756 | 🐛 536 | 🌐 Go | 📅 2026-09-20 - a subset of Go targeted to embedded devices and WebAssembly.
...
* [Grain](https://github.com/grain-lang/grain) ⭐ 3,465 | 🐛 281 | 🌐 Reason | 📅 2026-09-20 - main repository.
...
* [Janet](https://github.com/janet-lang/janet) ⭐ 4,419 | 🐛 63 | 🌐 C | 📅 2026-09-19 - main repository. You can try it out [here](https://janet-lang.org/#Try-It).
...
* [TeaVM](https://github.com/konsoletyper/teavm) ⭐ 3,113 | 🐛 191 | 🌐 Java | 📅 2026-09-15 - an ahead-of-time translating compiler (transpiler) of Java bytecode, that's capable of emitting JavaScript and WebAssembly.
* [JWebAssembly](https://github.com/i-net-software/JWebAssembly) ⭐ 1,055 | 🐛 22 | 🌐 Java | 📅 2026-08-17 - A Java bytecode to WebAssembly compiler. It can generate the WebAssembly binary or text format. It is written in Java itself and can be integrated with other Java build tools.
...
* [hermes](https://github.com/facebook/hermes) ⭐ 11,313 | 🐛 252 | 🌐 JavaScript | 📅 2026-09-19 - Hermes is a JavaScript engine optimized for fast start-up of React Native apps. It features ahead-of-time static optimization and compact bytecode. [Emscripten](https://github.com/facebook/hermes/blob/main/doc/Emscripten.md) ⭐ 11,313 | 🐛 252 | 🌐 JavaScript | 📅 2026-09-19 and [WASI](https://github.com/guest271314/hermes/blob/shermes-wasm/doc/WASI.md) ⭐ 0 | 🐛 0 | 📅 2025-02-11 support.
...
* [Boa](https://github.com/boa-dev/boa) ⭐ 7,563 | 🐛 213 | 🌐 Rust | 📅 2026-09-20 - an embeddable and experimental Javascript engine written in Rust. You can try it out [here](https://boajs.dev/boa/playground/).
* [goja](https://github.com/dop251/goja) ⭐ 7,107 | 🐛 32 | 🌐 Go | 📅 2026-09-17 - an implementation of ECMAScript 5.1 in pure Go with emphasis on standard compliance and performance.
...
* [Porffor](https://github.com/CanadaHonk/porffor) ⭐ 5,225 | 🐛 29 | 🌐 JavaScript | 📅 2026-09-17 - a from-scratch experimental AOT optimizing JS/TS -> Wasm/C engine/compiler/runtime. You can try it out [here](https://porffor.dev/).
* [Jint](https://github.com/sebastienros/jint) ⭐ 4,721 | 🐛 32 | 🌐 C# | 📅 2026-09-21 - an embeddable Javascript interpreter for .NET which can run on any modern .NET platform as it supports .NET Standard 2.0 and .NET 4.6.2 targets (and later).
...
* [quickjs-emscripten](https://github.com/justjake/quickjs-emscripten) ⭐ 1,714 | 🐛 40 | 🌐 TypeScript | 📅 2026-07-23 - Safely execute untrusted Javascript in your JS/TS, and execute synchronous code that uses async functions.
* [sebastianwessel-quickjs](https://github.com/sebastianwessel/quickjs) ⭐ 933 | 🐛 1 | 🌐 TypeScript | 📅 2026-06-08 - a typescript package to execute JavaScript and TypeScript code in a webassembly quickjs sandbox. You can try it out [here](https://sebastianwessel.github.io/quickjs/playground.html).
...
* [KCLVM](https://github.com/KusionStack/KCLVM) ⭐ 2,416 | 🐛 15 | 🌐 Rust | 📅 2026-09-21 - LLVM-based KCL compiler, which can generate WASM.
...
* [Lobster github](https://github.com/aardappel/lobster) ⭐ 2,739 | 🐛 15 | 🌐 C++ | 📅 2026-09-21
...
* [Core library](https://github.com/moonbitlang/core) ⭐ 1,215 | 🐛 111 | 🌐 MoonBit | 📅 2026-09-21 - open-sourced standard library. Compiler source code is not available yet.
...
* [Nelua](https://github.com/edubart/nelua-lang/) ⭐ 2,424 | 🐛 27 | 🌐 Lua | 📅 2025-06-24 - project repository
* [Nelua on the Web](https://github.com/edubart/nelua-lang/discussions/11) ⭐ 2,424 | 🐛 27 | 🌐 Lua | 📅 2025-06-24 - Nelua-wasm discussion
...
* [Never](https://github.com/never-lang/never) ⭐ 460 | 🐛 2 | 🌐 C | 📅 2024-05-12 - project repository
...
* [nlvm](https://github.com/arnetheduck/nlvm) ⭐ 775 | 🐛 12 | 🌐 Nim | 📅 2026-09-21 - LLVM-based compiler for Nim with a WebAssembly target supported out of the box
...
* [PHP WASM](https://github.com/soyuka/php-wasm) ⭐ 98 | 🐛 3 | 🌐 Dockerfile | 📅 2024-10-16 - maintained fork of PIB with PHP 8 support based on the work of [seanmorris](https://github.com/seanmorris/php-wasm) ⭐ 1,367 | 🐛 39 | 🌐 PHP | 📅 2026-09-21.
...
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,355 | 🐛 395 | 🌐 Rust | 📅 2026-09-21 - A Python 3 interpreter written in Rust. Check the demo [here](https://rustpython.github.io/demo/)
* [MicroPython](https://github.com/micropython/micropython/tree/master/ports/webassembly) ⭐ 22,076 | 🐛 1,530 | 🌐 C | 📅 2026-09-21 - a lean and efficient Python implementation for microcontrollers and constrained systems.
* [Pyodide](https://github.com/iodide-project/pyodide) ⭐ 14,839 | 🐛 394 | 🌐 Python | 📅 2026-09-18 - a port of Python to WebAssembly that includes the core packages of the scientific Python stack (Numpy, Pandas, matplotlib).  Objects transparently convert and share between Python and Javascript.
...
* [OPA-Wasm](https://github.com/open-policy-agent/opa/tree/main/wasm) ⭐ 12,260 | 🐛 306 | 🌐 Go | 📅 2026-09-21 - Compilation and evaluation of Rego policies using Wasm.
...
* [roc](https://github.com/roc-lang/roc) ⭐ 6,064 | 🐛 237 | 🌐 Zig | 📅 2026-09-21 - main repository. You can try it out [here](https://www.roc-lang.org/#try-roc).
* [basic-cli](https://github.com/roc-lang/basic-cli) ⭐ 121 | 🐛 24 | 🌐 Rust | 📅 2026-09-11 - a Roc [platform](https://github.com/roc-lang/roc/wiki/Roc-concepts-explained#platform) ⭐ 6,064 | 🐛 237 | 🌐 Zig | 📅 2026-09-21 to work with files, commands, HTTP, TCP, command line arguments, etc.
* [basic-webserver](https://github.com/roc-lang/basic-webserver) ⭐ 107 | 🐛 12 | 🌐 HTML | 📅 2026-09-20 - a basic Web Server for Roc.
...
* [ruby.wasm](https://github.com/ruby/ruby.wasm/) ⭐ 875 | 🐛 40 | 🌐 Ruby | 📅 2026-09-21 - a collection of "official" WebAssembly ports of the CRuby. You can
...
* [Wasm-Bindgen](https://github.com/rustwasm/wasm-bindgen) ⭐ 9,153 | 🐛 563 | 🌐 Rust | 📅 2026-09-18 - A library and a CLI for Rust that facilitate high-level interactions between wasm modules and JavaScript.
...
* [V](https://github.com/vlang/v) ⭐ 37,886 | 🐛 127 | 🌐 V | 📅 2026-09-21 - main repository. You can try it out [here](https://play.vlang.io/)
...
* [Virgil](https://github.com/titzer/virgil) ⭐ 1,421 | 🐛 37 | 🌐 Shell | 📅 2026-09-21 - main repository.
...
* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 8,029 | 🐛 19 | 🌐 C | 📅 2026-09-19 - main repository.
...
* [xcc](https://github.com/tyfkda/xcc) ⭐ 549 | 🐛 22 | 🌐 C | 📅 2026-09-09 - main repository.
