...
* [Blazor](https://dotnet.microsoft.com/apps/aspnet/web-apps/blazor) - a web UI framework using C#/Razor and HTML, running client-side via WebAssembly. Source is maintained on [ASP.Net Core](https://github.com/dotnet/aspnetcore) ⭐ 38,458 | 🐛 4,170 | 🌐 C# | 📅 2026-09-22 repo.
* [Mono](https://github.com/mono/mono/tree/master/sdks/wasm) ⭐ 11,465 | 🐛 2,267 | 🌐 C# | 📅 2024-08-27 - an open source implementation of Microsoft's .NET Framework based on the ECMA standards for C# and the Common Language Runtime. For a real-work example, see this repository which contains the [Windows 10 calculator](https://github.com/nventive/calculator) ⭐ 415 | 🐛 61 | 🌐 C# | 📅 2025-08-26. The application is built using standard C++ 11 and C++/CX, with a calculation engine that dates back from 1995. Made by possible with mono via [Uno Platform](https://platform.uno/a-piece-of-windows-10-is-now-running-on-webassembly-natively-on-ios-and-android/).
* [NativeAOT-LLVM](https://github.com/dotnet/runtimelab/tree/feature/NativeAOT-LLVM) ⭐ 1,617 | 🐛 249 | 📅 2026-09-22 - an experimental fork of the CoreCLR .NET runtime that compiles .NET applications into single-file executables, with the primary target being WASM
...
* [adawebpack](https://github.com/godunko/adawebpack) ⭐ 84 | 🐛 5 | 🌐 Ada | 📅 2025-02-16 - GNAT-LLVM compiler for WebAssembly target, GNAT Run Time Library and AdaWebPack bindings for Web API.
...
* [AssemblyScript](https://github.com/AssemblyScript/assemblyscript) ⭐ 18,023 | 🐛 203 | 🌐 WebAssembly | 📅 2026-09-14 - main repository.
...
* ~~[Astro](https://github.com/astrolang/astro) ⭐ 805 | 🐛 7 | 🌐 Rust | 📅 2023-08-10 - main repository.~~ `Unmaintained`
...
> The WebAssembly compiler is implemented for the native Ballerina compiler [nBallerina](https://github.com/ballerina-platform/nballerina) ⭐ 143 | 🐛 88 | 🌐 Ballerina | 📅 2024-10-23.

* [Main repository](https://github.com/ballerina-platform/nballerina/tree/wasm) ⭐ 143 | 🐛 88 | 🌐 Ballerina | 📅 2024-10-23 - Ballerina-to-wasm compiler
...
* [EndBASIC](https://github.com/endbasic/endbasic) ⭐ 384 | 🐛 30 | 🌐 Rust | 📅 2026-09-20 - BASIC environment with a REPL, a web interface, a graphical console, and RPi support written in Rust. You can try it out [here](https://repl.endbasic.dev/).
...
* [berry](https://github.com/berry-lang/berry) ⭐ 1,063 | 🐛 12 | 🌐 C | 📅 2026-09-14 - main repo.
...
* [Emscripten](https://github.com/kripken/emscripten) ⭐ 27,624 | 🐛 2,491 | 🌐 C++ | 📅 2026-09-22 - an LLVM-to-JavaScript/Webassembly compiler. It takes LLVM bitcode - which can be generated from C/C++, using llvm-gcc (DragonEgg) or clang, or any other language that can be converted into LLVM - and compiles that into JavaScript or wasm.
...
* [Cobaul](https://github.com/cloudflare/cobaul) ⭐ 401 | 🐛 4 | 🌐 COBOL | 📅 2026-04-23 - toolchain used to [support COBOL in CloudFlare workers](https://blog.cloudflare.com/cloudflare-workers-now-support-cobol/)
...
* [Coi](https://github.com/io-eric/coi) ⭐ 569 | 🐛 2 | 🌐 C++ | 📅 2026-09-08 - main repository.
...
* [Crystal](https://github.com/crystal-lang/crystal) ⭐ 20,417 | 🐛 2,043 | 🌐 Crystal | 📅 2026-09-22 - main repository
* [POC PR](https://github.com/crystal-lang/crystal/pull/10870) ⭐ 20,417 | 🐛 2,043 | 🌐 Crystal | 📅 2026-09-22 - PR adding initial support for WebAssembly
...
* [LDC](https://github.com/ldc-developers/ldc) ⭐ 1,370 | 🐛 584 | 🌐 D | 📅 2026-09-22 - LLVM-based D compiler, which can generate WASM since version 1.11.0.
...
* [sdk](https://github.com/dart-lang/sdk) ⭐ 11,288 | 🐛 8,406 | 🌐 Dart | 📅 2026-09-22 - The Dart SDK, including the VM, dart2js, core libraries, and more.
* [language](https://github.com/dart-lang/language) ⭐ 2,932 | 🐛 1,284 | 🌐 TeX | 📅 2026-09-18 - Design of the Dart language
...
* [eel-wasm](https://github.com/captbaritone/eel-wasm) ⭐ 60 | 🐛 10 | 🌐 TypeScript | 📅 2025-12-16 - Compiles Milkdrop flavored Eel to Wasm in the browser. Intended to become a component of [Butterchurn](https://github.com/jberg/butterchurn) ⭐ 1,951 | 🐛 24 | 🌐 JavaScript | 📅 2026-04-20, a WebGL implementation of the Milkdrop Visualizer.
...
* [Faust](https://github.com/grame-cncm/faust) ⭐ 3,161 | 🐛 246 | 🌐 C++ | 📅 2026-09-22 - main repository.
...
* [WAForth](https://github.com/remko/waforth) ⭐ 591 | 🐛 8 | 🌐 WebAssembly | 📅 2025-07-15 - Bootstrapping Dynamic Forth Interpreter/Compiler for & in WebAssembly.
...
* [Go](https://github.com/golang/go) ⭐ 138,935 | 🐛 10,176 | 🌐 Go | 📅 2026-09-22 - main repository.
* [TinyGo](https://github.com/aykevl/tinygo) ⭐ 17,768 | 🐛 532 | 🌐 Go | 📅 2026-09-22 - a subset of Go targeted to embedded devices and WebAssembly.
...
* [Grain](https://github.com/grain-lang/grain) ⭐ 3,465 | 🐛 280 | 🌐 Reason | 📅 2026-09-21 - main repository.
...
* [Janet](https://github.com/janet-lang/janet) ⭐ 4,421 | 🐛 63 | 🌐 C | 📅 2026-09-19 - main repository. You can try it out [here](https://janet-lang.org/#Try-It).
...
* [TeaVM](https://github.com/konsoletyper/teavm) ⭐ 3,114 | 🐛 191 | 🌐 Java | 📅 2026-09-15 - an ahead-of-time translating compiler (transpiler) of Java bytecode, that's capable of emitting JavaScript and WebAssembly.
* [JWebAssembly](https://github.com/i-net-software/JWebAssembly) ⭐ 1,056 | 🐛 22 | 🌐 Java | 📅 2026-08-17 - A Java bytecode to WebAssembly compiler. It can generate the WebAssembly binary or text format. It is written in Java itself and can be integrated with other Java build tools.
...
* [hermes](https://github.com/facebook/hermes) ⭐ 11,314 | 🐛 252 | 🌐 JavaScript | 📅 2026-09-19 - Hermes is a JavaScript engine optimized for fast start-up of React Native apps. It features ahead-of-time static optimization and compact bytecode. [Emscripten](https://github.com/facebook/hermes/blob/main/doc/Emscripten.md) ⭐ 11,314 | 🐛 252 | 🌐 JavaScript | 📅 2026-09-19 and [WASI](https://github.com/guest271314/hermes/blob/shermes-wasm/doc/WASI.md) ⭐ 0 | 🐛 0 | 📅 2025-02-11 support.
* [otto](https://github.com/robertkrimen/otto) ⭐ 8,449 | 🐛 51 | 🌐 Go | 📅 2025-06-13 - a JavaScript parser and interpreter written natively in Go.
* [Boa](https://github.com/boa-dev/boa) ⭐ 7,564 | 🐛 213 | 🌐 Rust | 📅 2026-09-20 - an embeddable and experimental Javascript engine written in Rust. You can try it out [here](https://boajs.dev/boa/playground/).
* [goja](https://github.com/dop251/goja) ⭐ 7,109 | 🐛 32 | 🌐 Go | 📅 2026-09-17 - an implementation of ECMAScript 5.1 in pure Go with emphasis on standard compliance and performance.
* [Duktape](https://github.com/svaarala/duktape) ⭐ 6,210 | 🐛 473 | 🌐 JavaScript | 📅 2026-09-04 - an embeddable Javascript engine, with a focus on portability and compact footprint that's capable of being run in the browser via WebAssembly.
* [Porffor](https://github.com/CanadaHonk/porffor) ⭐ 5,228 | 🐛 29 | 🌐 JavaScript | 📅 2026-09-17 - a from-scratch experimental AOT optimizing JS/TS -> Wasm/C engine/compiler/runtime. You can try it out [here](https://porffor.dev/).
* [Jint](https://github.com/sebastienros/jint) ⭐ 4,722 | 🐛 13 | 🌐 C# | 📅 2026-09-22 - an embeddable Javascript interpreter for .NET which can run on any modern .NET platform as it supports .NET Standard 2.0 and .NET 4.6.2 targets (and later).
* [Javy](https://github.com/bytecodealliance/javy) ⭐ 2,751 | 🐛 22 | 🌐 Rust | 📅 2026-09-02 - a JavaScript to WebAssembly toolchain, capable of generating WASI-compatible modules from JS by embedding the QuickJS engine.
* [quickjs-emscripten](https://github.com/justjake/quickjs-emscripten) ⭐ 1,715 | 🐛 40 | 🌐 TypeScript | 📅 2026-07-23 - Safely execute untrusted Javascript in your JS/TS, and execute synchronous code that uses async functions.
* [sebastianwessel-quickjs](https://github.com/sebastianwessel/quickjs) ⭐ 934 | 🐛 1 | 🌐 TypeScript | 📅 2026-06-08 - a typescript package to execute JavaScript and TypeScript code in a webassembly quickjs sandbox. You can try it out [here](https://sebastianwessel.github.io/quickjs/playground.html).
* [wasmedge-quickjs](https://github.com/second-state/wasmedge-quickjs) ⭐ 564 | 🐛 64 | 🌐 JavaScript | 📅 2024-10-15 - A high-performance, secure, extensible, and OCI-complaint JavaScript runtime for WasmEdge.  Features TCP/UDP support via WasmEdge Sockets.
* [jz](https://github.com/dy/jz) ⭐ 166 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-21 - A minimal, fast AOT compiler for a functional JavaScript subset to WebAssembly.
...
* [KCLVM](https://github.com/KusionStack/KCLVM) ⭐ 2,416 | 🐛 13 | 🌐 Rust | 📅 2026-09-22 - LLVM-based KCL compiler, which can generate WASM.
...
* [Vireo](https://github.com/ni/vireosdk) ⚠️ Archived - An open-source runtime capable of running the virtual instrument assembly representation of the G dataflow graphical programming language created by G Web Development Software.
...
* [Wisp](https://github.com/mbrock/wisp) ⭐ 306 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-05 - Wisp is a Lisp system for WebAssembly and native execution.
...
* [Lobster github](https://github.com/aardappel/lobster) ⭐ 2,737 | 🐛 16 | 🌐 C++ | 📅 2026-09-22
...
* [loxcraft](https://github.com/ajeetdsouza/loxcraft) ⭐ 364 | 🐛 1 | 🌐 Rust | 📅 2026-08-24 uses WebAssembly for its [online playground](https://ajeetdsouza.github.io/loxcraft/).
...
* [GopherLua](https://github.com/yuin/gopher-lua) ⭐ 6,979 | 🐛 105 | 🌐 Go | 📅 2026-04-01 - a Lua5.1(+ goto statement in Lua5.2) VM and compiler written in Go. It provides Go APIs that allow you to easily embed a scripting language to your Go host programs.
...
* [Wasmoon](https://github.com/ceifa/wasmoon) ⭐ 699 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-07 - a high level Lua VM with JS bindings.
* [Pluto](https://github.com/PlutoLang/Pluto) ⭐ 698 | 🐛 26 | 🌐 C++ | 📅 2026-09-16 - a superset of Lua 5.4 with a focus on general-purpose programming. You can try it out [here](https://pluto-lang.org/web/).
...
* [Core library](https://github.com/moonbitlang/core) ⭐ 1,216 | 🐛 104 | 🌐 MoonBit | 📅 2026-09-22 - open-sourced standard library. Compiler source code is not available yet.
...
* [Nelua](https://github.com/edubart/nelua-lang/) ⭐ 2,425 | 🐛 27 | 🌐 Lua | 📅 2025-06-24 - project repository
* [Nelua on the Web](https://github.com/edubart/nelua-lang/discussions/11) ⭐ 2,425 | 🐛 27 | 🌐 Lua | 📅 2025-06-24 - Nelua-wasm discussion
...
* [Nerd](https://github.com/NerdLang/nerd) ⭐ 3,611 | 🐛 16 | 🌐 C++ | 📅 2023-01-25 - main repository.
...
* [Never](https://github.com/never-lang/never) ⭐ 459 | 🐛 2 | 🌐 C | 📅 2024-05-12 - project repository
...
* [nlvm](https://github.com/arnetheduck/nlvm) ⭐ 776 | 🐛 12 | 🌐 Nim | 📅 2026-09-21 - LLVM-based compiler for Nim with a WebAssembly target supported out of the box
...
* [PHP WASM](https://github.com/soyuka/php-wasm) ⭐ 98 | 🐛 3 | 🌐 Dockerfile | 📅 2024-10-16 - maintained fork of PIB with PHP 8 support based on the work of [seanmorris](https://github.com/seanmorris/php-wasm) ⭐ 1,367 | 🐛 39 | 🌐 PHP | 📅 2026-09-22.
...
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,353 | 🐛 397 | 🌐 Rust | 📅 2026-09-22 - A Python 3 interpreter written in Rust. Check the demo [here](https://rustpython.github.io/demo/)
* [MicroPython](https://github.com/micropython/micropython/tree/master/ports/webassembly) ⭐ 22,079 | 🐛 1,525 | 🌐 C | 📅 2026-09-21 - a lean and efficient Python implementation for microcontrollers and constrained systems.
* [Pyodide](https://github.com/iodide-project/pyodide) ⭐ 14,845 | 🐛 392 | 🌐 Python | 📅 2026-09-22 - a port of Python to WebAssembly that includes the core packages of the scientific Python stack (Numpy, Pandas, matplotlib).  Objects transparently convert and share between Python and Javascript.
...
* [Rye](https://github.com/refaktor/rye) ⭐ 703 | 🐛 3 | 🌐 Go | 📅 2026-09-19 - Rye is a high level, dynamic programming language based on ideas from Rebol, flavored by Factor, \*nix shells and Golang. Implemented in Golang. You can try it out [here](https://ryelang.org/).
* [Ren-C](https://github.com/metaeducation/ren-c) ⭐ 142 | 🐛 84 | 🌐 C | 📅 2026-07-16 - Ren-C is a deeply redesigned derivative of the Rebol 3 codebase. Features "user-friendly" API for C and JavaScript. It has WASM-powered [Ren-C's replpad-js](https://github.com/hostilefork/replpad-js) ⭐ 14 | 🐛 36 | 🌐 JavaScript | 📅 2025-12-16 - interactive Web Console for Rebol language (Ren-C branch).
...
* [OPA-Wasm](https://github.com/open-policy-agent/opa/tree/main/wasm) ⭐ 12,259 | 🐛 306 | 🌐 Go | 📅 2026-09-22 - Compilation and evaluation of Rego policies using Wasm.
...
* [Ring](https://github.com/ring-lang/ring) ⭐ 1,464 | 🐛 0 | 🌐 C | 📅 2026-09-20 - main repository. You can try it out [here](https://tio.run/#ring).
...
* [roc](https://github.com/roc-lang/roc) ⭐ 6,066 | 🐛 233 | 🌐 Zig | 📅 2026-09-22 - main repository. You can try it out [here](https://www.roc-lang.org/#try-roc).
* [basic-cli](https://github.com/roc-lang/basic-cli) ⭐ 121 | 🐛 24 | 🌐 Rust | 📅 2026-09-11 - a Roc [platform](https://github.com/roc-lang/roc/wiki/Roc-concepts-explained#platform) ⭐ 6,066 | 🐛 233 | 🌐 Zig | 📅 2026-09-22 to work with files, commands, HTTP, TCP, command line arguments, etc.
* [basic-webserver](https://github.com/roc-lang/basic-webserver) ⭐ 107 | 🐛 11 | 🌐 HTML | 📅 2026-09-21 - a basic Web Server for Roc.
...
* [ruby.wasm](https://github.com/ruby/ruby.wasm/) ⭐ 875 | 🐛 40 | 🌐 Ruby | 📅 2026-09-22 - a collection of "official" WebAssembly ports of the CRuby. You can
...
* [Wasm-Bindgen](https://github.com/rustwasm/wasm-bindgen) ⭐ 9,153 | 🐛 567 | 🌐 Rust | 📅 2026-09-21 - A library and a CLI for Rust that facilitate high-level interactions between wasm modules and JavaScript.
...
* [Uxn.wasm](https://github.com/remko/uxn.wasm) ⭐ 58 | 🐛 3 | 🌐 WebAssembly | 📅 2024-08-15 - WebAssembly implementation of the Uxn virtual machine
...
* [V](https://github.com/vlang/v) ⭐ 37,896 | 🐛 132 | 🌐 V | 📅 2026-09-22 - main repository. You can try it out [here](https://play.vlang.io/)
...
* [Virgil](https://github.com/titzer/virgil) ⭐ 1,421 | 🐛 36 | 🌐 Shell | 📅 2026-09-22 - main repository.
...
* [Wase](https://github.com/area9innovation/wase) ⭐ 47 | 🐛 0 | 🌐 WebAssembly | 📅 2023-03-08 - main repository.
...
* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 8,031 | 🐛 19 | 🌐 C | 📅 2026-09-19 - main repository.
...
* [xcc](https://github.com/tyfkda/xcc) ⭐ 549 | 🐛 22 | 🌐 C | 📅 2026-09-22 - main repository.
