...
* [Blazor](https://dotnet.microsoft.com/apps/aspnet/web-apps/blazor) - a web UI framework using C#/Razor and HTML, running client-side via WebAssembly. Source is maintained on [ASP.Net Core](https://github.com/dotnet/aspnetcore) ⭐ 38,399 | 🐛 4,136 | 🌐 C# | 📅 2026-08-30 repo.
...
* [Emscripten](https://github.com/kripken/emscripten) ⭐ 27,584 | 🐛 2,477 | 🌐 C++ | 📅 2026-08-30 - an LLVM-to-JavaScript/Webassembly compiler. It takes LLVM bitcode - which can be generated from C/C++, using llvm-gcc (DragonEgg) or clang, or any other language that can be converted into LLVM - and compiles that into JavaScript or wasm.
...
* [LDC](https://github.com/ldc-developers/ldc) ⭐ 1,367 | 🐛 582 | 🌐 D | 📅 2026-08-30 - LLVM-based D compiler, which can generate WASM since version 1.11.0.
...
* [sdk](https://github.com/dart-lang/sdk) ⭐ 11,268 | 🐛 8,434 | 🌐 Dart | 📅 2026-08-29 - The Dart SDK, including the VM, dart2js, core libraries, and more.
* [language](https://github.com/dart-lang/language) ⭐ 2,933 | 🐛 1,325 | 🌐 TeX | 📅 2026-08-27 - Design of the Dart language
...
* [Faust](https://github.com/grame-cncm/faust) ⭐ 3,141 | 🐛 243 | 🌐 C++ | 📅 2026-08-30 - main repository.
...
* [Go](https://github.com/golang/go) ⭐ 136,825 | 🐛 10,101 | 🌐 Go | 📅 2026-08-29 - main repository.
* [TinyGo](https://github.com/aykevl/tinygo) ⭐ 17,677 | 🐛 564 | 🌐 Go | 📅 2026-08-30 - a subset of Go targeted to embedded devices and WebAssembly.
...
* [Janet](https://github.com/janet-lang/janet) ⭐ 4,372 | 🐛 59 | 🌐 C | 📅 2026-08-29 - main repository. You can try it out [here](https://janet-lang.org/#Try-It).
...
* [Bytecoder](https://github.com/mirkosertic/Bytecoder) ⭐ 959 | 🐛 40 | 🌐 Java | 📅 2026-08-17 - A Rich Domain Model for Java Bytecode and Framework to interpret and transpile it to other languages such as JavaScript, OpenCL or WebAssembly.
...
* [hermes](https://github.com/facebook/hermes) ⭐ 11,277 | 🐛 237 | 🌐 JavaScript | 📅 2026-08-28 - Hermes is a JavaScript engine optimized for fast start-up of React Native apps. It features ahead-of-time static optimization and compact bytecode. [Emscripten](https://github.com/facebook/hermes/blob/main/doc/Emscripten.md) ⭐ 11,277 | 🐛 237 | 🌐 JavaScript | 📅 2026-08-28 and [WASI](https://github.com/guest271314/hermes/blob/shermes-wasm/doc/WASI.md) ⭐ 0 | 🐛 0 | 📅 2025-02-11 support.
...
* [Boa](https://github.com/boa-dev/boa) ⭐ 7,513 | 🐛 252 | 🌐 Rust | 📅 2026-08-30 - an embeddable and experimental Javascript engine written in Rust. You can try it out [here](https://boajs.dev/boa/playground/).
* [goja](https://github.com/dop251/goja) ⭐ 7,062 | 🐛 32 | 🌐 Go | 📅 2026-08-26 - an implementation of ECMAScript 5.1 in pure Go with emphasis on standard compliance and performance.
...
* [Porffor](https://github.com/CanadaHonk/porffor) ⭐ 5,092 | 🐛 33 | 🌐 JavaScript | 📅 2026-08-29 - a from-scratch experimental AOT optimizing JS/TS -> Wasm/C engine/compiler/runtime. You can try it out [here](https://porffor.dev/).
* [Jint](https://github.com/sebastienros/jint) ⭐ 4,711 | 🐛 26 | 🌐 C# | 📅 2026-08-30 - an embeddable Javascript interpreter for .NET which can run on any modern .NET platform as it supports .NET Standard 2.0 and .NET 4.6.2 targets (and later).
...
* [KCLVM](https://github.com/KusionStack/KCLVM) ⭐ 2,406 | 🐛 37 | 🌐 Rust | 📅 2026-08-30 - LLVM-based KCL compiler, which can generate WASM.
...
* [Lobster github](https://github.com/aardappel/lobster) ⭐ 2,734 | 🐛 18 | 🌐 C++ | 📅 2026-08-29
...
* [GopherLua](https://github.com/yuin/gopher-lua) ⭐ 6,975 | 🐛 103 | 🌐 Go | 📅 2026-04-01 - a Lua5.1(+ goto statement in Lua5.2) VM and compiler written in Go. It provides Go APIs that allow you to easily embed a scripting language to your Go host programs.
...
* [Core library](https://github.com/moonbitlang/core) ⭐ 1,191 | 🐛 127 | 🌐 MoonBit | 📅 2026-08-29 - open-sourced standard library. Compiler source code is not available yet.
...
* [PHP WASM](https://github.com/soyuka/php-wasm) ⭐ 99 | 🐛 3 | 🌐 Dockerfile | 📅 2024-10-16 - maintained fork of PIB with PHP 8 support based on the work of [seanmorris](https://github.com/seanmorris/php-wasm) ⭐ 1,362 | 🐛 38 | 🌐 PHP | 📅 2026-08-30.
...
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,315 | 🐛 402 | 🌐 Rust | 📅 2026-08-30 - A Python 3 interpreter written in Rust. Check the demo [here](https://rustpython.github.io/demo/)
* [MicroPython](https://github.com/micropython/micropython/tree/master/ports/webassembly) ⭐ 22,022 | 🐛 1,536 | 🌐 C | 📅 2026-08-28 - a lean and efficient Python implementation for microcontrollers and constrained systems.
...
* [OPA-Wasm](https://github.com/open-policy-agent/opa/tree/main/wasm) ⭐ 12,178 | 🐛 337 | 🌐 Go | 📅 2026-08-28 - Compilation and evaluation of Rego policies using Wasm.
...
* [Ring](https://github.com/ring-lang/ring) ⭐ 1,461 | 🐛 0 | 🌐 C | 📅 2026-08-29 - main repository. You can try it out [here](https://tio.run/#ring).
...
* [roc](https://github.com/roc-lang/roc) ⭐ 6,015 | 🐛 199 | 🌐 Zig | 📅 2026-08-30 - main repository. You can try it out [here](https://www.roc-lang.org/#try-roc).
* [basic-cli](https://github.com/roc-lang/basic-cli) ⭐ 120 | 🐛 21 | 🌐 Rust | 📅 2026-08-25 - a Roc [platform](https://github.com/roc-lang/roc/wiki/Roc-concepts-explained#platform) ⭐ 6,015 | 🐛 199 | 🌐 Zig | 📅 2026-08-30 to work with files, commands, HTTP, TCP, command line arguments, etc.
* [basic-webserver](https://github.com/roc-lang/basic-webserver) ⭐ 106 | 🐛 11 | 🌐 HTML | 📅 2026-08-29 - a basic Web Server for Roc.
...
* [ruby.wasm](https://github.com/ruby/ruby.wasm/) ⭐ 872 | 🐛 40 | 🌐 Ruby | 📅 2026-08-30 - a collection of "official" WebAssembly ports of the CRuby. You can
...
* [Wasm-Bindgen](https://github.com/rustwasm/wasm-bindgen) ⭐ 9,130 | 🐛 556 | 🌐 Rust | 📅 2026-08-28 - A library and a CLI for Rust that facilitate high-level interactions between wasm modules and JavaScript.
...
* [V](https://github.com/vlang/v) ⭐ 37,802 | 🐛 114 | 🌐 V | 📅 2026-08-30 - main repository. You can try it out [here](https://play.vlang.io/)
...
* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 8,008 | 🐛 19 | 🌐 C | 📅 2026-08-28 - main repository.
