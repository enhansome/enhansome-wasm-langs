...
* [Blazor](https://dotnet.microsoft.com/apps/aspnet/web-apps/blazor) - a web UI framework using C#/Razor and HTML, running client-side via WebAssembly. Source is maintained on [ASP.Net Core](https://github.com/dotnet/aspnetcore) ⭐ 38,459 | 🐛 4,178 | 🌐 C# | 📅 2026-09-25 repo.
* [Mono](https://github.com/mono/mono/tree/master/sdks/wasm) ⭐ 11,464 | 🐛 2,267 | 🌐 C# | 📅 2024-08-27 - an open source implementation of Microsoft's .NET Framework based on the ECMA standards for C# and the Common Language Runtime. For a real-work example, see this repository which contains the [Windows 10 calculator](https://github.com/nventive/calculator) ⭐ 415 | 🐛 61 | 🌐 C# | 📅 2025-08-26. The application is built using standard C++ 11 and C++/CX, with a calculation engine that dates back from 1995. Made by possible with mono via [Uno Platform](https://platform.uno/a-piece-of-windows-10-is-now-running-on-webassembly-natively-on-ios-and-android/).
* [NativeAOT-LLVM](https://github.com/dotnet/runtimelab/tree/feature/NativeAOT-LLVM) ⭐ 1,617 | 🐛 249 | 📅 2026-09-24 - an experimental fork of the CoreCLR .NET runtime that compiles .NET applications into single-file executables, with the primary target being WASM
...
* [AssemblyScript](https://github.com/AssemblyScript/assemblyscript) ⭐ 18,027 | 🐛 203 | 🌐 WebAssembly | 📅 2026-09-14 - main repository.
...
* [berry](https://github.com/berry-lang/berry) ⭐ 1,064 | 🐛 12 | 🌐 C | 📅 2026-09-24 - main repo.
...
* [Emscripten](https://github.com/kripken/emscripten) ⭐ 27,631 | 🐛 2,492 | 🌐 C++ | 📅 2026-09-25 - an LLVM-to-JavaScript/Webassembly compiler. It takes LLVM bitcode - which can be generated from C/C++, using llvm-gcc (DragonEgg) or clang, or any other language that can be converted into LLVM - and compiles that into JavaScript or wasm.
...
* [Coi](https://github.com/io-eric/coi) ⭐ 568 | 🐛 2 | 🌐 C++ | 📅 2026-09-08 - main repository.
...
* [Crystal](https://github.com/crystal-lang/crystal) ⭐ 20,423 | 🐛 2,030 | 🌐 Crystal | 📅 2026-09-25 - main repository
* [POC PR](https://github.com/crystal-lang/crystal/pull/10870) ⭐ 20,423 | 🐛 2,030 | 🌐 Crystal | 📅 2026-09-25 - PR adding initial support for WebAssembly
...
* [Cyber](https://github.com/fubark/cyber) ⭐ 1,521 | 🐛 37 | 🌐 Zig | 📅 2025-12-21 - project repository
...
* [LDC](https://github.com/ldc-developers/ldc) ⭐ 1,371 | 🐛 584 | 🌐 D | 📅 2026-09-24 - LLVM-based D compiler, which can generate WASM since version 1.11.0.
...
* [sdk](https://github.com/dart-lang/sdk) ⭐ 11,288 | 🐛 8,419 | 🌐 Dart | 📅 2026-09-25 - The Dart SDK, including the VM, dart2js, core libraries, and more.
...
* [eel-wasm](https://github.com/captbaritone/eel-wasm) ⭐ 60 | 🐛 10 | 🌐 TypeScript | 📅 2025-12-16 - Compiles Milkdrop flavored Eel to Wasm in the browser. Intended to become a component of [Butterchurn](https://github.com/jberg/butterchurn) ⭐ 1,955 | 🐛 24 | 🌐 JavaScript | 📅 2026-04-20, a WebGL implementation of the Milkdrop Visualizer.
...
* [Faust](https://github.com/grame-cncm/faust) ⭐ 3,163 | 🐛 251 | 🌐 C++ | 📅 2026-09-24 - main repository.
...
* [Go](https://github.com/golang/go) ⭐ 138,994 | 🐛 10,235 | 🌐 Go | 📅 2026-09-24 - main repository.
* [TinyGo](https://github.com/aykevl/tinygo) ⭐ 17,785 | 🐛 534 | 🌐 Go | 📅 2026-09-25 - a subset of Go targeted to embedded devices and WebAssembly.
...
* [Grain](https://github.com/grain-lang/grain) ⭐ 3,464 | 🐛 280 | 🌐 Reason | 📅 2026-09-21 - main repository.
...
* [Janet](https://github.com/janet-lang/janet) ⭐ 4,424 | 🐛 62 | 🌐 C | 📅 2026-09-24 - main repository. You can try it out [here](https://janet-lang.org/#Try-It).
...
* [hermes](https://github.com/facebook/hermes) ⭐ 11,322 | 🐛 259 | 🌐 JavaScript | 📅 2026-09-25 - Hermes is a JavaScript engine optimized for fast start-up of React Native apps. It features ahead-of-time static optimization and compact bytecode. [Emscripten](https://github.com/facebook/hermes/blob/main/doc/Emscripten.md) ⭐ 11,322 | 🐛 259 | 🌐 JavaScript | 📅 2026-09-25 and [WASI](https://github.com/guest271314/hermes/blob/shermes-wasm/doc/WASI.md) ⭐ 0 | 🐛 0 | 📅 2025-02-11 support.
...
* [Boa](https://github.com/boa-dev/boa) ⭐ 7,567 | 🐛 213 | 🌐 Rust | 📅 2026-09-20 - an embeddable and experimental Javascript engine written in Rust. You can try it out [here](https://boajs.dev/boa/playground/).
* [goja](https://github.com/dop251/goja) ⭐ 7,112 | 🐛 33 | 🌐 Go | 📅 2026-09-23 - an implementation of ECMAScript 5.1 in pure Go with emphasis on standard compliance and performance.
* [Duktape](https://github.com/svaarala/duktape) ⭐ 6,212 | 🐛 473 | 🌐 JavaScript | 📅 2026-09-04 - an embeddable Javascript engine, with a focus on portability and compact footprint that's capable of being run in the browser via WebAssembly.
* [Porffor](https://github.com/CanadaHonk/porffor) ⭐ 5,240 | 🐛 29 | 🌐 JavaScript | 📅 2026-09-24 - a from-scratch experimental AOT optimizing JS/TS -> Wasm/C engine/compiler/runtime. You can try it out [here](https://porffor.dev/).
* [Jint](https://github.com/sebastienros/jint) ⭐ 4,725 | 🐛 16 | 🌐 C# | 📅 2026-09-25 - an embeddable Javascript interpreter for .NET which can run on any modern .NET platform as it supports .NET Standard 2.0 and .NET 4.6.2 targets (and later).
...
* [quickjs-emscripten](https://github.com/justjake/quickjs-emscripten) ⭐ 1,717 | 🐛 40 | 🌐 TypeScript | 📅 2026-07-23 - Safely execute untrusted Javascript in your JS/TS, and execute synchronous code that uses async functions.
* [sebastianwessel-quickjs](https://github.com/sebastianwessel/quickjs) ⭐ 935 | 🐛 1 | 🌐 TypeScript | 📅 2026-06-08 - a typescript package to execute JavaScript and TypeScript code in a webassembly quickjs sandbox. You can try it out [here](https://sebastianwessel.github.io/quickjs/playground.html).
...
* [jz](https://github.com/dy/jz) ⭐ 170 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-25 - A minimal, fast AOT compiler for a functional JavaScript subset to WebAssembly.
...
* [KCLVM](https://github.com/KusionStack/KCLVM) ⭐ 2,418 | 🐛 14 | 🌐 Rust | 📅 2026-09-25 - LLVM-based KCL compiler, which can generate WASM.
...
* [Lobster github](https://github.com/aardappel/lobster) ⭐ 2,739 | 🐛 15 | 🌐 C++ | 📅 2026-09-25
...
* [GopherLua](https://github.com/yuin/gopher-lua) ⭐ 6,981 | 🐛 105 | 🌐 Go | 📅 2026-04-01 - a Lua5.1(+ goto statement in Lua5.2) VM and compiler written in Go. It provides Go APIs that allow you to easily embed a scripting language to your Go host programs.
...
* [Wasmoon](https://github.com/ceifa/wasmoon) ⭐ 700 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-07 - a high level Lua VM with JS bindings.
...
* [Core library](https://github.com/moonbitlang/core) ⭐ 1,218 | 🐛 111 | 🌐 MoonBit | 📅 2026-09-25 - open-sourced standard library. Compiler source code is not available yet.
...
* [Nelua](https://github.com/edubart/nelua-lang/) ⭐ 2,428 | 🐛 27 | 🌐 Lua | 📅 2025-06-24 - project repository
* [Nelua on the Web](https://github.com/edubart/nelua-lang/discussions/11) ⭐ 2,428 | 🐛 27 | 🌐 Lua | 📅 2025-06-24 - Nelua-wasm discussion
...
* [nlvm](https://github.com/arnetheduck/nlvm) ⭐ 777 | 🐛 11 | 🌐 Nim | 📅 2026-09-23 - LLVM-based compiler for Nim with a WebAssembly target supported out of the box
...
* ~~[OcamlRun](https://github.com/sebmarkbage/ocamlrun-wasm) ⭐ 258 | 🐛 1 | 🌐 Shell | 📅 2017-03-06 - a build script for compiling OCaml bytecode interpreter to wasm using emscripten \[Unmaintained]~~
...
* [PHP WASM](https://github.com/soyuka/php-wasm) ⭐ 98 | 🐛 3 | 🌐 Dockerfile | 📅 2024-10-16 - maintained fork of PIB with PHP 8 support based on the work of [seanmorris](https://github.com/seanmorris/php-wasm) ⭐ 1,368 | 🐛 39 | 🌐 PHP | 📅 2026-09-25.
...
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,366 | 🐛 397 | 🌐 Rust | 📅 2026-09-25 - A Python 3 interpreter written in Rust. Check the demo [here](https://rustpython.github.io/demo/)
* [MicroPython](https://github.com/micropython/micropython/tree/master/ports/webassembly) ⭐ 22,091 | 🐛 1,528 | 🌐 C | 📅 2026-09-21 - a lean and efficient Python implementation for microcontrollers and constrained systems.
* [Pyodide](https://github.com/iodide-project/pyodide) ⭐ 14,852 | 🐛 395 | 🌐 Python | 📅 2026-09-23 - a port of Python to WebAssembly that includes the core packages of the scientific Python stack (Numpy, Pandas, matplotlib).  Objects transparently convert and share between Python and Javascript.
...
* [Rye](https://github.com/refaktor/rye) ⭐ 703 | 🐛 3 | 🌐 Go | 📅 2026-09-24 - Rye is a high level, dynamic programming language based on ideas from Rebol, flavored by Factor, \*nix shells and Golang. Implemented in Golang. You can try it out [here](https://ryelang.org/).
...
* [OPA-Wasm](https://github.com/open-policy-agent/opa/tree/main/wasm) ⭐ 12,271 | 🐛 305 | 🌐 Go | 📅 2026-09-25 - Compilation and evaluation of Rego policies using Wasm.
...
* [Ring](https://github.com/ring-lang/ring) ⭐ 1,465 | 🐛 0 | 🌐 C | 📅 2026-09-25 - main repository. You can try it out [here](https://tio.run/#ring).
...
* [roc](https://github.com/roc-lang/roc) ⭐ 6,070 | 🐛 224 | 🌐 Zig | 📅 2026-09-25 - main repository. You can try it out [here](https://www.roc-lang.org/#try-roc).
* [basic-cli](https://github.com/roc-lang/basic-cli) ⭐ 121 | 🐛 26 | 🌐 Rust | 📅 2026-09-25 - a Roc [platform](https://github.com/roc-lang/roc/wiki/Roc-concepts-explained#platform) ⭐ 6,070 | 🐛 224 | 🌐 Zig | 📅 2026-09-25 to work with files, commands, HTTP, TCP, command line arguments, etc.
* [basic-webserver](https://github.com/roc-lang/basic-webserver) ⭐ 107 | 🐛 12 | 🌐 HTML | 📅 2026-09-24 - a basic Web Server for Roc.
...
* [ruby.wasm](https://github.com/ruby/ruby.wasm/) ⭐ 876 | 🐛 41 | 🌐 Ruby | 📅 2026-09-25 - a collection of "official" WebAssembly ports of the CRuby. You can
...
* [Wasm-Bindgen](https://github.com/rustwasm/wasm-bindgen) ⭐ 9,158 | 🐛 552 | 🌐 Rust | 📅 2026-09-25 - A library and a CLI for Rust that facilitate high-level interactions between wasm modules and JavaScript.
...
* [V](https://github.com/vlang/v) ⭐ 37,912 | 🐛 169 | 🌐 V | 📅 2026-09-25 - main repository. You can try it out [here](https://play.vlang.io/)
...
* [Virgil](https://github.com/titzer/virgil) ⭐ 1,422 | 🐛 37 | 🌐 Shell | 📅 2026-09-25 - main repository.
...
* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 8,034 | 🐛 18 | 🌐 C | 📅 2026-09-24 - main repository.
...
* [xcc](https://github.com/tyfkda/xcc) ⭐ 548 | 🐛 22 | 🌐 C | 📅 2026-09-22 - main repository.
