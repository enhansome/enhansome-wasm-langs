...
* [Blazor](https://dotnet.microsoft.com/apps/aspnet/web-apps/blazor) - a web UI framework using C#/Razor and HTML, running client-side via WebAssembly. Source is maintained on [ASP.Net Core](https://github.com/dotnet/aspnetcore) ⭐ 38,369 | 🐛 4,100 | 🌐 C# | 📅 2026-08-13 repo.
* [Mono](https://github.com/mono/mono/tree/master/sdks/wasm) ⭐ 11,462 | 🐛 2,265 | 🌐 C# | 📅 2024-08-27 - an open source implementation of Microsoft's .NET Framework based on the ECMA standards for C# and the Common Language Runtime. For a real-work example, see this repository which contains the [Windows 10 calculator](https://github.com/nventive/calculator) ⭐ 414 | 🐛 61 | 🌐 C# | 📅 2025-08-26. The application is built using standard C++ 11 and C++/CX, with a calculation engine that dates back from 1995. Made by possible with mono via [Uno Platform](https://platform.uno/a-piece-of-windows-10-is-now-running-on-webassembly-natively-on-ios-and-android/).
* [NativeAOT-LLVM](https://github.com/dotnet/runtimelab/tree/feature/NativeAOT-LLVM) ⭐ 1,616 | 🐛 256 | 📅 2026-08-10 - an experimental fork of the CoreCLR .NET runtime that compiles .NET applications into single-file executables, with the primary target being WASM
...
* [adawebpack](https://github.com/godunko/adawebpack) ⭐ 81 | 🐛 4 | 🌐 Ada | 📅 2025-02-16 - GNAT-LLVM compiler for WebAssembly target, GNAT Run Time Library and AdaWebPack bindings for Web API.
...
* [AssemblyScript](https://github.com/AssemblyScript/assemblyscript) ⭐ 17,990 | 🐛 199 | 🌐 WebAssembly | 📅 2026-07-22 - main repository.
...
* ~~[Astro](https://github.com/astrolang/astro) ⭐ 802 | 🐛 7 | 🌐 Rust | 📅 2023-08-10 - main repository.~~ `Unmaintained`
...
* [EndBASIC](https://github.com/endbasic/endbasic) ⭐ 385 | 🐛 30 | 🌐 Rust | 📅 2026-07-04 - BASIC environment with a REPL, a web interface, a graphical console, and RPi support written in Rust. You can try it out [here](https://repl.endbasic.dev/).
...
* [berry](https://github.com/berry-lang/berry) ⭐ 1,053 | 🐛 15 | 🌐 C | 📅 2026-08-13 - main repo.
...
* [Brainfuck Wa-lang](https://github.com/wa-lang/wa/tree/master/waroot/examples/brainfuck) ⭐ 1,768 | 🐛 6 | 🌐 Go | 📅 2026-04-30 - a Brainfuck interpreter written in [凹语言/Wa-lang](https://github.com/wa-lang/wa) ⭐ 1,768 | 🐛 6 | 🌐 Go | 📅 2026-04-30 and compiled to WebAssembly.
...
* [Emscripten](https://github.com/kripken/emscripten) ⭐ 27,568 | 🐛 2,463 | 🌐 C++ | 📅 2026-08-12 - an LLVM-to-JavaScript/Webassembly compiler. It takes LLVM bitcode - which can be generated from C/C++, using llvm-gcc (DragonEgg) or clang, or any other language that can be converted into LLVM - and compiles that into JavaScript or wasm.
* [Cheerp](https://github.com/leaningtech/cheerp-meta) ⭐ 1,188 | 🐛 5 | 🌐 JavaScript | 📅 2025-09-24 - an open-source, enterprise-grade C/C++ compiler for Web applications. Cheerp can compile virtually any C/C++ code to WebAssembly and/or JavaScript.
...
* [Cobaul](https://github.com/cloudflare/cobaul) ⭐ 397 | 🐛 4 | 🌐 COBOL | 📅 2026-04-23 - toolchain used to [support COBOL in CloudFlare workers](https://blog.cloudflare.com/cloudflare-workers-now-support-cobol/)
...
* [Coi](https://github.com/io-eric/coi) ⭐ 561 | 🐛 2 | 🌐 C++ | 📅 2026-08-04 - main repository.
...
* [Crystal](https://github.com/crystal-lang/crystal) ⭐ 20,371 | 🐛 2,034 | 🌐 Crystal | 📅 2026-08-12 - main repository
* [POC PR](https://github.com/crystal-lang/crystal/pull/10870) ⭐ 20,371 | 🐛 2,034 | 🌐 Crystal | 📅 2026-08-12 - PR adding initial support for WebAssembly
...
* [Cyber](https://github.com/fubark/cyber) ⭐ 1,515 | 🐛 37 | 🌐 Zig | 📅 2025-12-21 - project repository
...
* [LDC](https://github.com/ldc-developers/ldc) ⭐ 1,362 | 🐛 580 | 🌐 D | 📅 2026-08-13 - LLVM-based D compiler, which can generate WASM since version 1.11.0.
...
* [sdk](https://github.com/dart-lang/sdk) ⭐ 11,247 | 🐛 8,466 | 🌐 Dart | 📅 2026-08-13 - The Dart SDK, including the VM, dart2js, core libraries, and more.
* [language](https://github.com/dart-lang/language) ⭐ 2,931 | 🐛 1,325 | 🌐 TeX | 📅 2026-08-12 - Design of the Dart language
...
* [eel-wasm](https://github.com/captbaritone/eel-wasm) ⭐ 60 | 🐛 10 | 🌐 TypeScript | 📅 2025-12-16 - Compiles Milkdrop flavored Eel to Wasm in the browser. Intended to become a component of [Butterchurn](https://github.com/jberg/butterchurn) ⭐ 1,929 | 🐛 24 | 🌐 JavaScript | 📅 2026-04-20, a WebGL implementation of the Milkdrop Visualizer.
...
* [Faust](https://github.com/grame-cncm/faust) ⭐ 3,124 | 🐛 242 | 🌐 C++ | 📅 2026-08-12 - main repository.
...
* [WAForth](https://github.com/remko/waforth) ⭐ 589 | 🐛 8 | 🌐 WebAssembly | 📅 2025-07-15 - Bootstrapping Dynamic Forth Interpreter/Compiler for & in WebAssembly.
...
* [Go](https://github.com/golang/go) ⭐ 135,737 | 🐛 10,224 | 🌐 Go | 📅 2026-08-13 - main repository.
* [TinyGo](https://github.com/aykevl/tinygo) ⭐ 17,643 | 🐛 559 | 🌐 Go | 📅 2026-08-12 - a subset of Go targeted to embedded devices and WebAssembly.
...
* [Grain](https://github.com/grain-lang/grain) ⭐ 3,468 | 🐛 280 | 🌐 Reason | 📅 2026-06-28 - main repository.
...
* ~~[DHC](https://github.com/dfinity/dhc) ⭐ 167 | 🐛 2 | 🌐 Haskell | 📅 2019-03-04 - a Haskell compiler that accepts only a tiny subset of the language and produces WebAssembly binaries. \[Unmaintained]~~
...
* [Janet](https://github.com/janet-lang/janet) ⭐ 4,366 | 🐛 63 | 🌐 C | 📅 2026-08-08 - main repository. You can try it out [here](https://janet-lang.org/#Try-It).
...
* [TeaVM](https://github.com/konsoletyper/teavm) ⭐ 3,087 | 🐛 184 | 🌐 Java | 📅 2026-07-28 - an ahead-of-time translating compiler (transpiler) of Java bytecode, that's capable of emitting JavaScript and WebAssembly.
* [JWebAssembly](https://github.com/i-net-software/JWebAssembly) ⭐ 1,051 | 🐛 22 | 🌐 Java | 📅 2026-08-09 - A Java bytecode to WebAssembly compiler. It can generate the WebAssembly binary or text format. It is written in Java itself and can be integrated with other Java build tools.
* [Bytecoder](https://github.com/mirkosertic/Bytecoder) ⭐ 940 | 🐛 40 | 🌐 Java | 📅 2026-08-08 - A Rich Domain Model for Java Bytecode and Framework to interpret and transpile it to other languages such as JavaScript, OpenCL or WebAssembly.
* [CheerpJ](https://github.com/leaningtech/cheerpj-meta) ⭐ 678 | 🐛 14 | 📅 2026-06-12 - A Java compiler for the web that converts any Java client application into standard HTML5/WebAssembly/JavaScript.
...
* [hermes](https://github.com/facebook/hermes) ⭐ 11,247 | 🐛 225 | 🌐 JavaScript | 📅 2026-08-13 - Hermes is a JavaScript engine optimized for fast start-up of React Native apps. It features ahead-of-time static optimization and compact bytecode. [Emscripten](https://github.com/facebook/hermes/blob/main/doc/Emscripten.md) ⭐ 11,247 | 🐛 225 | 🌐 JavaScript | 📅 2026-08-13 and [WASI](https://github.com/guest271314/hermes/blob/shermes-wasm/doc/WASI.md) ⭐ 0 | 🐛 0 | 📅 2025-02-11 support.
* [otto](https://github.com/robertkrimen/otto) ⭐ 8,456 | 🐛 50 | 🌐 Go | 📅 2025-06-13 - a JavaScript parser and interpreter written natively in Go.
* [Boa](https://github.com/boa-dev/boa) ⭐ 7,476 | 🐛 252 | 🌐 Rust | 📅 2026-08-10 - an embeddable and experimental Javascript engine written in Rust. You can try it out [here](https://boajs.dev/boa/playground/).
* [goja](https://github.com/dop251/goja) ⭐ 7,045 | 🐛 31 | 🌐 Go | 📅 2026-08-06 - an implementation of ECMAScript 5.1 in pure Go with emphasis on standard compliance and performance.
* [Duktape](https://github.com/svaarala/duktape) ⭐ 6,208 | 🐛 474 | 🌐 JavaScript | 📅 2024-03-22 - an embeddable Javascript engine, with a focus on portability and compact footprint that's capable of being run in the browser via WebAssembly.
* [Porffor](https://github.com/CanadaHonk/porffor) ⭐ 4,964 | 🐛 16 | 🌐 JavaScript | 📅 2026-08-12 - a from-scratch experimental AOT optimizing JS/TS -> Wasm/C engine/compiler/runtime. You can try it out [here](https://porffor.dev/).
* [Jint](https://github.com/sebastienros/jint) ⭐ 4,698 | 🐛 13 | 🌐 C# | 📅 2026-08-12 - an embeddable Javascript interpreter for .NET which can run on any modern .NET platform as it supports .NET Standard 2.0 and .NET 4.6.2 targets (and later).
* [Javy](https://github.com/bytecodealliance/javy) ⭐ 2,732 | 🐛 22 | 🌐 Rust | 📅 2026-08-12 - a JavaScript to WebAssembly toolchain, capable of generating WASI-compatible modules from JS by embedding the QuickJS engine.
* [quickjs-emscripten](https://github.com/justjake/quickjs-emscripten) ⭐ 1,691 | 🐛 36 | 🌐 TypeScript | 📅 2026-07-23 - Safely execute untrusted Javascript in your JS/TS, and execute synchronous code that uses async functions.
* [sebastianwessel-quickjs](https://github.com/sebastianwessel/quickjs) ⭐ 927 | 🐛 1 | 🌐 TypeScript | 📅 2026-06-08 - a typescript package to execute JavaScript and TypeScript code in a webassembly quickjs sandbox. You can try it out [here](https://sebastianwessel.github.io/quickjs/playground.html).
...
* [jz](https://github.com/dy/jz) ⭐ 158 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-11 - A minimal, fast AOT compiler for a functional JavaScript subset to WebAssembly.
...
* [KCLVM](https://github.com/KusionStack/KCLVM) ⭐ 2,395 | 🐛 95 | 🌐 Rust | 📅 2026-08-13 - LLVM-based KCL compiler, which can generate WASM.
...
* [Kou](https://github.com/utatti/kou) ⭐ 138 | 🐛 1 | 🌐 TypeScript | 📅 2019-08-26 - main repository.
...
* [Vireo](https://github.com/ni/vireosdk) ⭐ 51 | 🐛 51 | 🌐 C++ | 📅 2024-07-16 - An open-source runtime capable of running the virtual instrument assembly representation of the G dataflow graphical programming language created by G Web Development Software.
...
* [Wisp](https://github.com/mbrock/wisp) ⭐ 305 | 🐛 15 | 🌐 JavaScript | 📅 2026-07-27 - Wisp is a Lisp system for WebAssembly and native execution.
...
* [Lobster github](https://github.com/aardappel/lobster) ⭐ 2,732 | 🐛 18 | 🌐 C++ | 📅 2026-08-11
...
* [loxcraft](https://github.com/ajeetdsouza/loxcraft) ⭐ 366 | 🐛 1 | 🌐 Rust | 📅 2026-04-12 uses WebAssembly for its [online playground](https://ajeetdsouza.github.io/loxcraft/).
...
* [GopherLua](https://github.com/yuin/gopher-lua) ⭐ 6,966 | 🐛 104 | 🌐 Go | 📅 2026-04-01 - a Lua5.1(+ goto statement in Lua5.2) VM and compiler written in Go. It provides Go APIs that allow you to easily embed a scripting language to your Go host programs.
...
* [Pluto](https://github.com/PlutoLang/Pluto) ⭐ 696 | 🐛 21 | 🌐 C++ | 📅 2026-08-07 - a superset of Lua 5.4 with a focus on general-purpose programming. You can try it out [here](https://pluto-lang.org/web/).
* [Wasmoon](https://github.com/ceifa/wasmoon) ⭐ 691 | 🐛 22 | 🌐 TypeScript | 📅 2026-07-29 - a high level Lua VM with JS bindings.
* [Wasm2Lua](https://github.com/SwadicalRag/wasm2lua) ⭐ 219 | 🐛 15 | 🌐 WebAssembly | 📅 2021-12-14 - can compile WebAssembly modules to pure Lua (or with FFI LuaJIT for extra speed).
...
* [Core library](https://github.com/moonbitlang/core) ⭐ 1,182 | 🐛 148 | 🌐 MoonBit | 📅 2026-08-13 - open-sourced standard library. Compiler source code is not available yet.
...
* [Nelua](https://github.com/edubart/nelua-lang/) ⭐ 2,409 | 🐛 25 | 🌐 Lua | 📅 2025-06-24 - project repository
* [Nelua on the Web](https://github.com/edubart/nelua-lang/discussions/11) ⭐ 2,409 | 🐛 25 | 🌐 Lua | 📅 2025-06-24 - Nelua-wasm discussion
...
* [Nerd](https://github.com/NerdLang/nerd) ⭐ 3,612 | 🐛 16 | 🌐 C++ | 📅 2023-01-25 - main repository.
...
* [nlvm](https://github.com/arnetheduck/nlvm) ⭐ 775 | 🐛 14 | 🌐 Nim | 📅 2026-07-26 - LLVM-based compiler for Nim with a WebAssembly target supported out of the box
* [nwasm](https://github.com/stisa/nwasm) ⭐ 51 | 🐛 1 | 📅 2020-09-01 - a webassembly backend for nim.
* [Nim wasm helpers](https://github.com/Feneric/nim-wasm-helpers) ⭐ 28 | 🐛 2 | 📅 2019-01-19 - a helper to set up a VM configured to build WebAssembly code using Nim.
...
* [Ocaml](https://github.com/SanderSpies/ocaml/tree/wasm/wasmcomp) ⭐ 79 | 🐛 12 | 🌐 OCaml | 📅 2020-09-01 - a fork of main repo containing work on OCaml to wasm compilation.
...
* [PHP WASM](https://github.com/soyuka/php-wasm) ⭐ 99 | 🐛 3 | 🌐 Dockerfile | 📅 2024-10-16 - maintained fork of PIB with PHP 8 support based on the work of [seanmorris](https://github.com/seanmorris/php-wasm) ⭐ 1,358 | 🐛 40 | 🌐 PHP | 📅 2026-08-12.
...
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,276 | 🐛 405 | 🌐 Rust | 📅 2026-08-12 - A Python 3 interpreter written in Rust. Check the demo [here](https://rustpython.github.io/demo/)
* [MicroPython](https://github.com/micropython/micropython/tree/master/ports/webassembly) ⭐ 21,986 | 🐛 1,545 | 🌐 C | 📅 2026-08-13 - a lean and efficient Python implementation for microcontrollers and constrained systems.
* [Pyodide](https://github.com/iodide-project/pyodide) ⭐ 14,784 | 🐛 400 | 🌐 Python | 📅 2026-08-12 - a port of Python to WebAssembly that includes the core packages of the scientific Python stack (Numpy, Pandas, matplotlib).  Objects transparently convert and share between Python and Javascript.
...
* [Ciao Prolog](https://github.com/ciao-lang/ciao) ⭐ 348 | 🐛 49 | 🌐 Prolog | 📅 2025-06-21 - includes a WebAssembly compilation target based on Emscripten. Ciao Prolog is a modern Prolog implementation designed to be portable, extensible and modular. Check the playground [here](https://ciao-lang.org/playground).
...
* [Rye](https://github.com/refaktor/rye) ⭐ 701 | 🐛 8 | 🌐 Go | 📅 2026-08-06 - Rye is a high level, dynamic programming language based on ideas from Rebol, flavored by Factor, \*nix shells and Golang. Implemented in Golang. You can try it out [here](https://ryelang.org/).
...
* [OPA-Wasm](https://github.com/open-policy-agent/opa/tree/main/wasm) ⭐ 12,096 | 🐛 350 | 🌐 Go | 📅 2026-08-12 - Compilation and evaluation of Rego policies using Wasm.
* [npm-opa-wasm](https://github.com/open-policy-agent/npm-opa-wasm) ⭐ 156 | 🐛 16 | 🌐 JavaScript | 📅 2026-07-10 - NPM module providing an SDK for using Wasm compiled OPA policies.
* [rust-opa-wasm](https://github.com/matrix-org/rust-opa-wasm) ⭐ 79 | 🐛 12 | 🌐 Rust | 📅 2026-08-04 - A crate to use OPA policies compiled to Wasm.
...
* [Ring](https://github.com/ring-lang/ring) ⭐ 1,458 | 🐛 0 | 🌐 C | 📅 2026-08-12 - main repository. You can try it out [here](https://tio.run/#ring).
...
* [roc](https://github.com/roc-lang/roc) ⭐ 5,935 | 🐛 188 | 🌐 Zig | 📅 2026-08-13 - main repository. You can try it out [here](https://www.roc-lang.org/#try-roc).
* [basic-cli](https://github.com/roc-lang/basic-cli) ⭐ 119 | 🐛 23 | 🌐 Rust | 📅 2026-08-10 - a Roc [platform](https://github.com/roc-lang/roc/wiki/Roc-concepts-explained#platform) ⭐ 5,935 | 🐛 188 | 🌐 Zig | 📅 2026-08-13 to work with files, commands, HTTP, TCP, command line arguments, etc.
* [basic-webserver](https://github.com/roc-lang/basic-webserver) ⭐ 106 | 🐛 10 | 🌐 HTML | 📅 2026-08-12 - a basic Web Server for Roc.
...
* [ruby.wasm](https://github.com/ruby/ruby.wasm/) ⭐ 866 | 🐛 41 | 🌐 Ruby | 📅 2026-08-13 - a collection of "official" WebAssembly ports of the CRuby. You can
  try it out [here](https://try.ruby-lang.org/playground/#code=puts+RUBY_DESCRIPTION\&engine=cruby-3.2.0)
* [run.rb](https://github.com/jasoncharnes/run.rb) ⭐ 596 | 🐛 31 | 🌐 JavaScript | 📅 2022-12-10 run.rb - allows you to run Ruby code in the browser
...
* [Wasm-Bindgen](https://github.com/rustwasm/wasm-bindgen) ⭐ 9,118 | 🐛 560 | 🌐 Rust | 📅 2026-08-12 - A library and a CLI for Rust that facilitate high-level interactions between wasm modules and JavaScript.
...
* [Schism](https://github.com/schism-lang/schism) ⭐ 220 | 🐛 2 | 📅 2020-06-02 - Schism is an experimental self-hosting compiler from a subset of R6RS Scheme to WebAssembly. Development so far has focused on features necessary for self-hosting. The compiler itself is written in, and compiles, a very small subset of Scheme.
...
* [V](https://github.com/vlang/v) ⭐ 37,791 | 🐛 87 | 🌐 V | 📅 2026-08-13 - main repository. You can try it out [here](https://play.vlang.io/)
...
* [Virgil](https://github.com/titzer/virgil) ⭐ 1,416 | 🐛 41 | 🌐 Shell | 📅 2026-08-12 - main repository.
...
* [Wa/凹语言(仓库)](https://github.com/wa-lang/wa) ⭐ 1,768 | 🐛 6 | 🌐 Go | 📅 2026-04-30 - main repository.
...
* ~~[Walt](https://github.com/ballercat/walt) ⭐ 4,632 | 🐛 27 | 🌐 JavaScript | 📅 2023-01-02 - main repository.~~ `Unmaintained`
...
* ~~[Wam](https://github.com/kanaka/wam) ⭐ 64 | 🐛 0 | 🌐 JavaScript | 📅 2019-08-07 - main repository.~~ `Unmaintained`
...
* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 7,972 | 🐛 64 | 🌐 C | 📅 2026-08-12 - main repository.
...
* [Wonkey](https://github.com/wonkey-coders/wonkey) ⭐ 147 | 🐛 1 | 🌐 C++ | 📅 2026-05-31 - main repository. Check the demo games [here](https://wonkey-coders.github.io/examples/).
...
* [xcc](https://github.com/tyfkda/xcc) ⭐ 539 | 🐛 22 | 🌐 C | 📅 2026-08-11 - main repository.
